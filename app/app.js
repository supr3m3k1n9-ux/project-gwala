...
const reportGroups = [
  ...
  {
    label: "Research",
    reports: ["strategy_vault", "strategy_evidence_accumulator", "paper_activation_rules", "vwap_mean_reversion", "vwap_mean_reversion_walk_forward", "vwap_mean_reversion_shadow_samples", "vwap_mean_reversion_forward_observations", "vwap_mean_reversion_paper_watch_gate", "opening_range_breakout", "trend_pullback_continuation", "opening_range_failure", "strategy_improvement_plan", "feature_wiring_audit", "research_confidence", "promotion_review", "controlled_variant_review", "walk_forward_review", "regime_review", "strategy_overlap_audit", "opening_range_relaxation"],
  },
  {
    label: "Deep Research",
    reports: [
