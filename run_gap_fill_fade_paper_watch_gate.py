"""Paper-watch gate for Gap Fill / Gap Fade.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Gap Fill / Gap Fade paper-watch gate.")
...
def build_gate(args: argparse.Namespace):
    """Build the Gap Fill / Gap Fade paper-watch gate."""
