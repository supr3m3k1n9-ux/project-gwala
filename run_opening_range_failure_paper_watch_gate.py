"""Paper-watch gate for Opening Range Failure.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Opening Range Failure paper-watch gate.")
...
def build_gate(args: argparse.Namespace):
    """Build the Opening Range Failure paper-watch gate."""
