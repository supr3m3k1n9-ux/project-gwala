"""Collect Opening Range Failure forward observations."""
...
from run_opening_range_failure_shadow_samples import SPEC
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Collect Opening Range Failure forward observations.")
    ...
    parser.add_argument("--observations-csv", type=Path, default=Path("data/opening_range_failure_forward_observations.csv"))
...
def main() -> None:
    ...
    print(f"Opening Range Failure forward observation status: {result['append_status']}")
